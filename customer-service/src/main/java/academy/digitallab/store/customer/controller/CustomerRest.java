...
public class CustomerRest {
    ...
    /**
     * Indicates which instance resolves the request
     * @param request catch user petition
     * @return URL of instance that responded
     */
    @GetMapping("/test")
    public String greetingInstance(HttpServletRequest request) {
        String greeting = String.valueOf(request.getRequestURL());
        System.out.printf("Hello, I am: %s", greeting);
        return greeting;
    }
